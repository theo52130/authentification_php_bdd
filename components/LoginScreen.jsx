...
const LoginScreen = ({ navigation }) => {
    ...
    const handleLogin = async () => {
        try {
            const response = await fetch('http://192.168.1.143/dashboard/authentification_php_bdd/back-end/api/api-connect.php', {
                method: 'POST',
                headers: {
            ...
            if (data.status === 'success' && data.user) {
                ...
                if (userId !== undefined && userRole !== undefined) {
                    ...
                    const tokenResponse = await fetch('http://192.168.1.143/dashboard/authentification_php_bdd/back-end/includes/generate-token.php', {
                        method: 'POST',
                        headers: {
