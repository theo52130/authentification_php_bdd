					...
					<View style={styles.container}>
						...
						<RNPickerSelect
							...
							items={[{
								...
								value: ''
							}, ...clients.map(client => ({label: client.nom, value: client.id}))]}
								...
								<View key={index} style={styles.produitContainer}>
									<RNPickerSelect
										...
										items={[{
											...
											value: ''
										}, ...produits.map(prod => ({label: prod.description, value: prod.id}))]}
										style={pickerSelectStyles}
										value={produit.id}
									/>
									<TextInput
						...
						<Button title="Ajouter un produit"
								onPress={() => setSelectedProduits([...selectedProduits, {id: '', quantite: 1}])}/>
