...
import {View, Text, Button, FlatList, Alert, TouchableOpacity, ActivityIndicator, Image, Linking} from 'react-native';
        ...
        <View style={{flex: 1, padding: 20}}>
            <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                <TouchableOpacity onPress={() => {
                    setCategories('comptes');
                    fetchUsers();
                }}>
                    <Text style={{
                        textDecorationLine: categories === 'comptes' ? 'underline' : 'none',
                        fontSize: 20,
                        color: 'blue' // Vous pouvez changer la couleur si nécessaire
                    }}>
                        Comptes
                    </Text>
                </TouchableOpacity>
                ...
                <View style={{flexDirection: 'row'}}>
                    <TouchableOpacity onPress={() => {
                        categories === 'comptes' ? fetchUsers() : fetchFactures();
                ...
                <FlatList
                    ...
                    renderItem={({item}) => (
                        <View style={{
                            ...
                            <View>
                                <Text
                                    style={{fontSize: 18}}>{categories === 'comptes' ? item.nom : `Ref : ${item.id}`}</Text>
                                    ...
                                    <>
										...
										<View style={{ padding: 20 }}>
											...
											<Button 
												...
												onPress={() => downloadPDF(item.id)} // ID de la facture
												style={{ marginTop: 20 }}
											/>
										</View>
                                ...
                                {categories === 'comptes' && (
                                    <View style={{flexDirection: 'row', justifyContent: 'space-around', marginTop: 10}}>
                                        ...
                                        <Button
                                            title="Modifier"
                                            onPress={() => navigation.navigate('Modifier compte', {user: item})}
                                        />
                                    </View>
                                )}
                            </View>
